...
We use the 1.2 version of poetry.  To obtain it, run the following update command:
```
poetry self update --preview
```
Restart the shell and confirm successful installation of a 1.2 version of poetry:
```
poetry --version
```
...
information on using pull requests.  What follows is a step-by-step guide for contributing.
