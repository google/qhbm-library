...
class QHBM(tf.keras.layers.Layer):
  ...
  def circuits(self, model: hamiltonian_model.Hamiltonian, num_samples: int):
    ...
    Args:
      model: The modular Hamiltonian whose normalized exponential is the density
        operator from which states will be approximately sampled.
  ...
  def expectation(self,
    ...
    Args:
      model: The modular Hamiltonian whose normalized exponential is the density
        operator against which expectation values will be estimated.
