...
class QuantumCircuitTest(tf.test.TestCase):
  ...
  def setUp(self):
    ...
    self.actual_layer = circuit.QuantumCircuit(
  ...
  def test_add(self):
    ...
    other_layer = circuit.QuantumCircuit(
...
class DirectQuantumCircuitTest(tf.test.TestCase):
  ...
  def test_init(self):
    ...
    actual_qnn = circuit.DirectQuantumCircuit(
