  ...
  def test_zero_grad(self):
    ...
    for num_qubits in [1, 2, 3, 4, 5, 6]:
      ...
      target_circuits, _, target_counts = qhbm.sample_state_circuits(
          target_qhbm.sampler_function, target_qhbm.thetas,
          target_qhbm.bit_and_u, target_qhbm.bit_symbols,
          target_qhbm.phis_symbols, target_qhbm.phis, target_samples)
      ...
      phis_grad = qmhl.qmhl_loss_phis_grad(
          model_qhbm, target_density, eps=.02)
